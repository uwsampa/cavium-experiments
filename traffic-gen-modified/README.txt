Note that I, Teddy Brow, have made a few modifications to this program for the
purpose of measuring bandwidth. The main change was adding an "ethernet" packet
type (e.g. "tx.type <port> ethernet"). To see details in code, search for
comments containing "MODIFIED". The following is the original README for this
example program.
